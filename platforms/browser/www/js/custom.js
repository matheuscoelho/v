...
$(document).on('submit', '#finalizar_form', function () {
    ...
    var msgPedido = "Confirme seu pedido.</br>";
        ...
        $(".id_produto").each( function(index, value) { 
            ...
            if(parseInt($(this).val()) > 0){ 
                ...
                msg += $(this).attr('nome_produto') + '. qtde: ' + $(this).val() + ', subtotal: R$' + total + '\n';
                total_geral += total;
        ...
        if(total_geral > 0){
            ...
            if (r == true) {
                ...
                jQuery.ajax({
                    type: "POST",
                    url: "http://vipsio.com.br/admin/api_2/finalizar_compra_api.php",
                    data: {id_empresa:id_empresa_finaliza, id_produto:id_produto, qtde:qtde, usuario: localStorage.usuario, token: localStorage.token },
                    success: function (data) {
